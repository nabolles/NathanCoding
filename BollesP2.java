...
public class BollesP2 extends Application {
    public static void main(String[] args) {
        BollesP2.launch(args);
    }
...
//        		assign(j+1, temp);
    	...
    	for(int i= 0; i < full; i++){
    		paint(i, COLOR_INITIAL);	//something kept happening where the colors would'nt fully go back
    		// so I implemented this to change them all back
    	}
    }
